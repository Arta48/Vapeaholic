...
public class NightVisionOrangeVape extends Item {

    public NightVisionOrangeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"night_vision_orange_vape")))
