...
public class SlownessLimeVape extends Item {

    public SlownessLimeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slowness_lime_vape")))
