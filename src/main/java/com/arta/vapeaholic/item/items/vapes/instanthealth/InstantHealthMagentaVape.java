...
public class InstantHealthMagentaVape extends Item {

    public InstantHealthMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_health_magenta_vape")))
