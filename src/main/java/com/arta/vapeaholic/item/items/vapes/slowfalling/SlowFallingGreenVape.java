...
public class SlowFallingGreenVape extends Item {

    public SlowFallingGreenVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slow_falling_green_vape")))
