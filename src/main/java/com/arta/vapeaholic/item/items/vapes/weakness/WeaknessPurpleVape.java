...
public class WeaknessPurpleVape extends Item {

    public WeaknessPurpleVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"weakness_purple_vape")))
