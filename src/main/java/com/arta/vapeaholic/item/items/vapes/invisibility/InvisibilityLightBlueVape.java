...
public class InvisibilityLightBlueVape extends Item {

    public InvisibilityLightBlueVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"invisibility_light_blue_vape")))
