...
public class InstantHealthWhiteVape extends Item {

    public InstantHealthWhiteVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_health_white_vape")))
