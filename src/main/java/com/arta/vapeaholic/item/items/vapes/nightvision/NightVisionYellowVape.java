...
public class NightVisionYellowVape extends Item {

    public NightVisionYellowVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"night_vision_yellow_vape")))
