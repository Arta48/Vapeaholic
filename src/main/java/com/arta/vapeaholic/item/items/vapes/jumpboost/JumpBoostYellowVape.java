...
public class JumpBoostYellowVape extends Item {

    public JumpBoostYellowVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"jump_boost_yellow_vape")))
