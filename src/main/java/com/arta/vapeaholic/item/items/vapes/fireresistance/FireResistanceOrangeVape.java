...
public class FireResistanceOrangeVape extends Item {

    public FireResistanceOrangeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"fire_resistance_orange_vape")))
