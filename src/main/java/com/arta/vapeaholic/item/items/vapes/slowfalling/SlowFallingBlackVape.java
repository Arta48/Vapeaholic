...
public class SlowFallingBlackVape extends Item {

    public SlowFallingBlackVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slow_falling_black_vape")))
