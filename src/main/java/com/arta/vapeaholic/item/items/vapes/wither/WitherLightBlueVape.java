...
public class WitherLightBlueVape extends Item {

    public WitherLightBlueVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"wither_light_blue_vape")))
