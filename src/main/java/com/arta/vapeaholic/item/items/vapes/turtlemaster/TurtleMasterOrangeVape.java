...
public class TurtleMasterOrangeVape extends Item {

    public TurtleMasterOrangeVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_orange_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"orange_vape"))
            .overrideDescription("item.vapeaholic.orange_vape")
        );
    }
