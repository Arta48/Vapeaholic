...
public class NightVisionGreenVape extends Item {

    public NightVisionGreenVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"night_vision_green_vape")))
