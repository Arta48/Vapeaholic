...
public class FireResistanceBlueVape extends Item {

    public FireResistanceBlueVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"fire_resistance_blue_vape")))
