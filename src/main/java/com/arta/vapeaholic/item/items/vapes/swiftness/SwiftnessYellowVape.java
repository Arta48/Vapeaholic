...
public class SwiftnessYellowVape extends Item {

    public SwiftnessYellowVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"swiftness_yellow_vape")))
