...
public class PoisonLightGrayVape extends Item {

    public PoisonLightGrayVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"poison_light_gray_vape")))
