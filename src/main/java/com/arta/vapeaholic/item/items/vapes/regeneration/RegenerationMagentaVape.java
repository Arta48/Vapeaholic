...
public class RegenerationMagentaVape extends Item {

    public RegenerationMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"regeneration_magenta_vape")))
