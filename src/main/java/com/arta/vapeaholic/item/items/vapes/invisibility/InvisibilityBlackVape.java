...
public class InvisibilityBlackVape extends Item {

    public InvisibilityBlackVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"invisibility_black_vape")))
