...
public class FireResistanceYellowVape extends Item {

    public FireResistanceYellowVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"fire_resistance_yellow_vape")))
