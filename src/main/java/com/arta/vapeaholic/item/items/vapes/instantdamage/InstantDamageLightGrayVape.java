...
public class InstantDamageLightGrayVape extends Item {

    public InstantDamageLightGrayVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_damage_light_gray_vape")))
