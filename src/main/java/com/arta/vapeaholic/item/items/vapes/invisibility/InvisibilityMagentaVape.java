...
public class InvisibilityMagentaVape extends Item {

    public InvisibilityMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"invisibility_magenta_vape")))
