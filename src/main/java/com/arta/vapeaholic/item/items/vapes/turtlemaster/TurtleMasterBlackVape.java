...
public class TurtleMasterBlackVape extends Item {

    public TurtleMasterBlackVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_black_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"black_vape"))
            .overrideDescription("item.vapeaholic.black_vape")
        );
    }
