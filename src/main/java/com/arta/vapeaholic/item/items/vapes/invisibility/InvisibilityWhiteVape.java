...
public class InvisibilityWhiteVape extends Item {

    public InvisibilityWhiteVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"invisibility_white_vape")))
