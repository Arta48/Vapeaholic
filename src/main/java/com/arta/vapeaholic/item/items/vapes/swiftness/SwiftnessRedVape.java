...
public class SwiftnessRedVape extends Item {

    public SwiftnessRedVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"swiftness_red_vape")))
