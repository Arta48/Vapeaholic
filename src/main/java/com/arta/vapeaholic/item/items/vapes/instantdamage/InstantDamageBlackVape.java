...
public class InstantDamageBlackVape extends Item {

    public InstantDamageBlackVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_damage_black_vape")))
