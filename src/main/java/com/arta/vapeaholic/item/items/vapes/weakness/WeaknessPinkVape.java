...
public class WeaknessPinkVape extends Item {

    public WeaknessPinkVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"weakness_pink_vape")))
