...
public class NightVisionBrownVape extends Item {

    public NightVisionBrownVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"night_vision_brown_vape")))
