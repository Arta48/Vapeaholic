...
public class TurtleMasterBrownVape extends Item {

    public TurtleMasterBrownVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_brown_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"brown_vape"))
            .overrideDescription("item.vapeaholic.brown_vape")
        );
    }
