...
public class StrengthPurpleVape extends Item {

    public StrengthPurpleVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"strength_purple_vape")))
