...
public class InstantDamageBlueVape extends Item {

    public InstantDamageBlueVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_damage_blue_vape")))
