...
public class SlowFallingBrownVape extends Item {

    public SlowFallingBrownVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slow_falling_brown_vape")))
