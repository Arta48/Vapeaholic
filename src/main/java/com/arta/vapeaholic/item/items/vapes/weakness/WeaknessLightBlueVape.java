...
public class WeaknessLightBlueVape extends Item {

    public WeaknessLightBlueVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"weakness_light_blue_vape")))
