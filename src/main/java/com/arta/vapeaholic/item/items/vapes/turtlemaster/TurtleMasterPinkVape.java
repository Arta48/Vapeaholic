...
public class TurtleMasterPinkVape extends Item {

    public TurtleMasterPinkVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_pink_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"pink_vape"))
            .overrideDescription("item.vapeaholic.pink_vape")
        );
    }
