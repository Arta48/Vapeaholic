...
public class RegenerationYellowVape extends Item {

    public RegenerationYellowVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"regeneration_yellow_vape")))
