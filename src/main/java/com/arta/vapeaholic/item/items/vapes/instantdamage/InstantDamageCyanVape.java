...
public class InstantDamageCyanVape extends Item {

    public InstantDamageCyanVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_damage_cyan_vape")))
