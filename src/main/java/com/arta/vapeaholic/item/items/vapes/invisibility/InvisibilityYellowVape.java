...
public class InvisibilityYellowVape extends Item {

    public InvisibilityYellowVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"invisibility_yellow_vape")))
