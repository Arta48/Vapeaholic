...
public class WaterBreathingBrownVape extends Item {

    public WaterBreathingBrownVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_brown_vape")))
