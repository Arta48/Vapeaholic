...
public class InstantHealthLimeVape extends Item {

    public InstantHealthLimeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_health_lime_vape")))
