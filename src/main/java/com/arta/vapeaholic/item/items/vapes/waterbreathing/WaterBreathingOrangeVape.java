...
public class WaterBreathingOrangeVape extends Item {

    public WaterBreathingOrangeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_orange_vape")))
