...
public class InvisibilityPinkVape extends Item {

    public InvisibilityPinkVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"invisibility_pink_vape")))
