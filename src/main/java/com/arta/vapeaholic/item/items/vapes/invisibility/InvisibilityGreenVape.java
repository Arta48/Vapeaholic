...
public class InvisibilityGreenVape extends Item {

    public InvisibilityGreenVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"invisibility_green_vape")))
