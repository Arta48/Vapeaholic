...
public class TurtleMasterLightGrayVape extends Item {

    public TurtleMasterLightGrayVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_light_gray_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"light_gray_vape"))
            .overrideDescription("item.vapeaholic.light_gray_vape")
        );
    }
