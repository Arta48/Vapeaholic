...
public class InstantDamagePinkVape extends Item {

    public InstantDamagePinkVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_damage_pink_vape")))
