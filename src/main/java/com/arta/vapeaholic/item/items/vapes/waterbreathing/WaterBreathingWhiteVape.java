...
public class WaterBreathingWhiteVape extends Item {

    public WaterBreathingWhiteVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_white_vape")))
