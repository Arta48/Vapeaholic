...
public class InvisibilityBlueVape extends Item {

    public InvisibilityBlueVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"invisibility_blue_vape")))
