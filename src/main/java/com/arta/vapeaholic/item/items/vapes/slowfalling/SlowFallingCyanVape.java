...
public class SlowFallingCyanVape extends Item {

    public SlowFallingCyanVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slow_falling_cyan_vape")))
