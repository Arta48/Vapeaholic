...
public class InstantHealthPurpleVape extends Item {

    public InstantHealthPurpleVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_health_purple_vape")))
