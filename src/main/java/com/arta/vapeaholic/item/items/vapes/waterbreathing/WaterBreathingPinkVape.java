...
public class WaterBreathingPinkVape extends Item {

    public WaterBreathingPinkVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_pink_vape")))
