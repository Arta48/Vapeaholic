...
public class SlowFallingOrangeVape extends Item {

    public SlowFallingOrangeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slow_falling_orange_vape")))
