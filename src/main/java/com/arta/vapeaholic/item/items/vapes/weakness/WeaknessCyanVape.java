...
public class WeaknessCyanVape extends Item {

    public WeaknessCyanVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"weakness_cyan_vape")))
