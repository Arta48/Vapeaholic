...
public class SwiftnessMagentaVape extends Item {

    public SwiftnessMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"swiftness_magenta_vape")))
