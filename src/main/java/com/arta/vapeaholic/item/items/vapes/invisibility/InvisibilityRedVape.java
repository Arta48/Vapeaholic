...
public class InvisibilityRedVape extends Item {

    public InvisibilityRedVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"invisibility_red_vape")))
