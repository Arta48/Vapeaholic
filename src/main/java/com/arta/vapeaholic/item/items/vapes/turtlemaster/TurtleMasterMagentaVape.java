...
public class TurtleMasterMagentaVape extends Item {

    public TurtleMasterMagentaVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_magenta_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"magenta_vape"))
            .overrideDescription("item.vapeaholic.magenta_vape")
        );
    }
