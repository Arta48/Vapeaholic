...
public class TurtleMasterLightBlueVape extends Item {
    ...
    public ActionResult use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        effectList.add(StatusEffects.RESISTANCE);
        RightClickProcedure.execute(world, playerEntity.getX(), playerEntity.getY(), playerEntity.getZ(), playerEntity, itemStack, ModParticleTypes.TURTLE_MASTER_PARTICLE, effectList);
