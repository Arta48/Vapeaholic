...
public class FireResistanceLightBlueVape extends Item {
    ...
    public FireResistanceLightBlueVape(String name) {
        super();

        this.setRegistryName(name);
		this.setTranslationKey(Vapeaholic.MOD_ID + "." + "light_blue_vape");
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) {
		tooltip.add(translateToLocal("item.vapeoholic.fire_resistance_vape.tooltip"));
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entityPlayer, EnumHand hand) {
		...
		RightClickProcedure.execute(world, entityPlayer.posX, entityPlayer.posY, entityPlayer.posZ, entityPlayer, itemStack, ModParticleTypes.FIRE_RESISTANCE_PARTICLE, effectList);
