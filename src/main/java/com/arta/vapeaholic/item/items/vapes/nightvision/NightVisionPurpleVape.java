...
public class NightVisionPurpleVape extends Item {

    public NightVisionPurpleVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"night_vision_purple_vape")))
