...
public class WeaknessMagentaVape extends Item {

    public WeaknessMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"weakness_magenta_vape")))
