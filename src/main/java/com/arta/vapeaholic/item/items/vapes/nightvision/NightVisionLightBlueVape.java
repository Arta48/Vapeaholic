...
public class NightVisionLightBlueVape extends Item {
    ...
    public NightVisionLightBlueVape(String name) {
        super();
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) {
		tooltip.add(translateToLocal("item.vapeoholic.night_vision_vape.tooltip"));
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entityPlayer, EnumHand hand) {
		...
		RightClickProcedure.execute(world, entityPlayer.posX, entityPlayer.posY, entityPlayer.posZ, entityPlayer, itemStack, ModParticleTypes.NIGHT_VISION_PARTICLE, effectList);
