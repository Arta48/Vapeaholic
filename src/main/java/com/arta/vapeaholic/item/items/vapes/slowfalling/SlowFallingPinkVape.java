...
public class SlowFallingPinkVape extends Item {

    public SlowFallingPinkVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slow_falling_pink_vape")))
