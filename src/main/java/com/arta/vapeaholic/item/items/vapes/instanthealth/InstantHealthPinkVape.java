...
public class InstantHealthPinkVape extends Item {

    public InstantHealthPinkVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_health_pink_vape")))
