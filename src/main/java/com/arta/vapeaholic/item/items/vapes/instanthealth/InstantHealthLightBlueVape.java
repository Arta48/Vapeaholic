...
public class InstantHealthLightBlueVape extends Item {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, TooltipDisplayComponent displayComponent, Consumer<Text> textConsumer, TooltipType type) {
        textConsumer.accept(Text.translatable("item.vapeoholic.instant_health_vape.tooltip"));
    }
    ...
    public ActionResult use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        effectList.add(StatusEffects.INSTANT_HEALTH);
        RightClickProcedure.execute(world, playerEntity.getX(), playerEntity.getY(), playerEntity.getZ(), playerEntity, itemStack, ModParticleTypes.INSTANT_HEALTH_PARTICLE, effectList);
