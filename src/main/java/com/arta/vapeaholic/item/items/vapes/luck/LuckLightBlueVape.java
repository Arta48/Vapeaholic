...
public class LuckLightBlueVape extends Item {
    ...
    public LuckLightBlueVape(String name) {
        super();
	...
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) {
		tooltip.add(translateToLocal("item.vapeoholic.luck_vape.tooltip"));
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entityPlayer, EnumHand hand) {
		...
		RightClickProcedure.execute(world, entityPlayer.posX, entityPlayer.posY, entityPlayer.posZ, entityPlayer, itemStack, ModParticleTypes.LUCK_PARTICLE, effectList);
