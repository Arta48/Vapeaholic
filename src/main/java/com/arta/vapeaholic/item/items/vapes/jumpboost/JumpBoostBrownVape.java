...
public class JumpBoostBrownVape extends Item {

    public JumpBoostBrownVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"jump_boost_brown_vape")))
