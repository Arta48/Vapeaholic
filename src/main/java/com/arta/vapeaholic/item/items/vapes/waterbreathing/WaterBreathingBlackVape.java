...
public class WaterBreathingBlackVape extends Item {

    public WaterBreathingBlackVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_black_vape")))
