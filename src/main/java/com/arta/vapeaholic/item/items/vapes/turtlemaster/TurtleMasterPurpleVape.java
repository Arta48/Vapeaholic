...
public class TurtleMasterPurpleVape extends Item {

    public TurtleMasterPurpleVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_purple_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"purple_vape"))
            .overrideDescription("item.vapeaholic.purple_vape")
        );
    }
