...
public class TurtleMasterWhiteVape extends Item {

    public TurtleMasterWhiteVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_white_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"white_vape"))
            .overrideDescription("item.vapeaholic.white_vape")
        );
    }
