...
public class JumpBoostCyanVape extends Item {

    public JumpBoostCyanVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"jump_boost_cyan_vape")))
