...
public class InstantHealthGreenVape extends Item {

    public InstantHealthGreenVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_health_green_vape")))
