...
public class TurtleMasterRedVape extends Item {

    public TurtleMasterRedVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_red_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"red_vape"))
            .overrideDescription("item.vapeaholic.red_vape")
        );
    }
