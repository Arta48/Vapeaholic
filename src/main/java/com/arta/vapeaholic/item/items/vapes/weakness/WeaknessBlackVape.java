...
public class WeaknessBlackVape extends Item {

    public WeaknessBlackVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"weakness_black_vape")))
