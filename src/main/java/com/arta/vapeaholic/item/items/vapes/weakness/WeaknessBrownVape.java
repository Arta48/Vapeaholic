...
public class WeaknessBrownVape extends Item {

    public WeaknessBrownVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"weakness_brown_vape")))
