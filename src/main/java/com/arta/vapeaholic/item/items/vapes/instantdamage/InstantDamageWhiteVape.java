...
public class InstantDamageWhiteVape extends Item {

    public InstantDamageWhiteVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_damage_white_vape")))
