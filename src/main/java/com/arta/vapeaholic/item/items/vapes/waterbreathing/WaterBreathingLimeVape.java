...
public class WaterBreathingLimeVape extends Item {

    public WaterBreathingLimeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_lime_vape")))
