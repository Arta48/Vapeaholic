...
public class JumpBoostOrangeVape extends Item {

    public JumpBoostOrangeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"jump_boost_orange_vape")))
