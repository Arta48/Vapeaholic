...
public class JumpBoostMagentaVape extends Item {

    public JumpBoostMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"jump_boost_magenta_vape")))
