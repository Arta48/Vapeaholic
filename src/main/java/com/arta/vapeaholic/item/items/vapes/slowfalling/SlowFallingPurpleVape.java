...
public class SlowFallingPurpleVape extends Item {

    public SlowFallingPurpleVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slow_falling_purple_vape")))
