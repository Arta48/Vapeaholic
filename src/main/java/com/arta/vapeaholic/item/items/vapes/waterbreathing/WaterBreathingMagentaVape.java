...
public class WaterBreathingMagentaVape extends Item {

    public WaterBreathingMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_magenta_vape")))
