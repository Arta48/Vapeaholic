...
public class JumpBoostPinkVape extends Item {

    public JumpBoostPinkVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"jump_boost_pink_vape")))
