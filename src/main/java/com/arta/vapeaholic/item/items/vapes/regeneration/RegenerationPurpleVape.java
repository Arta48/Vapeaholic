...
public class RegenerationPurpleVape extends Item {

    public RegenerationPurpleVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"regeneration_purple_vape")))
