...
public class InstantHealthBrownVape extends Item {

    public InstantHealthBrownVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_health_brown_vape")))
