...
public class WaterBreathingRedVape extends Item {

    public WaterBreathingRedVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_red_vape")))
