...
public class TurtleMasterYellowVape extends Item {

    public TurtleMasterYellowVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_yellow_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"yellow_vape"))
            .overrideDescription("item.vapeaholic.yellow_vape")
        );
    }
