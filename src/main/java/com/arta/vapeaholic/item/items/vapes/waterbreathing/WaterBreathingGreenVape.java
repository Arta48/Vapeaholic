...
public class WaterBreathingGreenVape extends Item {

    public WaterBreathingGreenVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_green_vape")))
