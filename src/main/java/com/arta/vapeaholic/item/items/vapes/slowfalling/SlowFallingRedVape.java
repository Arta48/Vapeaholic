...
public class SlowFallingRedVape extends Item {

    public SlowFallingRedVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slow_falling_red_vape")))
