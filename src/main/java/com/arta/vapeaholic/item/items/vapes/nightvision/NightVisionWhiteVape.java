...
public class NightVisionWhiteVape extends Item {

    public NightVisionWhiteVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"night_vision_white_vape")))
