...
public class WaterBreathingLightGrayVape extends Item {

    public WaterBreathingLightGrayVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_light_gray_vape")))
