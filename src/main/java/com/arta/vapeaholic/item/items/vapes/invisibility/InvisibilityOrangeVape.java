...
public class InvisibilityOrangeVape extends Item {

    public InvisibilityOrangeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"invisibility_orange_vape")))
