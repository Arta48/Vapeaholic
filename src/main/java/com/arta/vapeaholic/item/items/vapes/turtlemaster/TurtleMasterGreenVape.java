...
public class TurtleMasterGreenVape extends Item {

    public TurtleMasterGreenVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_green_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"green_vape"))
            .overrideDescription("item.vapeaholic.green_vape")
        );
    }
