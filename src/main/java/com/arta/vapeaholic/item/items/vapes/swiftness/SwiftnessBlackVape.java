...
public class SwiftnessBlackVape extends Item {

    public SwiftnessBlackVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"swiftness_black_vape")))
