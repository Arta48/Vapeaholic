...
public class SlownessPinkVape extends Item {

    public SlownessPinkVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slowness_pink_vape")))
