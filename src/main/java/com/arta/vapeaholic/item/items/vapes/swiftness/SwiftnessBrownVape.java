...
public class SwiftnessBrownVape extends Item {

    public SwiftnessBrownVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"swiftness_brown_vape")))
