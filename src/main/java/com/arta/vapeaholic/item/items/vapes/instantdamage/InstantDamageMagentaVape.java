...
public class InstantDamageMagentaVape extends Item {

    public InstantDamageMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_damage_magenta_vape")))
