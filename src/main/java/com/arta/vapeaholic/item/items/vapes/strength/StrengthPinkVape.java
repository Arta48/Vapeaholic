...
public class StrengthPinkVape extends Item {

    public StrengthPinkVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"strength_pink_vape")))
