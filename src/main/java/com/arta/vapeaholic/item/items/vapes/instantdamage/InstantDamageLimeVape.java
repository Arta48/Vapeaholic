...
public class InstantDamageLimeVape extends Item {

    public InstantDamageLimeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_damage_lime_vape")))
