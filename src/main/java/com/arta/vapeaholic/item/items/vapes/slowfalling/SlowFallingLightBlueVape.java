...
public class SlowFallingLightBlueVape extends Item {

    public SlowFallingLightBlueVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slow_falling_light_blue_vape")))
