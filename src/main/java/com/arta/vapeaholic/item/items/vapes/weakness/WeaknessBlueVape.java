...
public class WeaknessBlueVape extends Item {

    public WeaknessBlueVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"weakness_blue_vape")))
