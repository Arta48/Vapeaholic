...
public class InstantHealthCyanVape extends Item {

    public InstantHealthCyanVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_health_cyan_vape")))
