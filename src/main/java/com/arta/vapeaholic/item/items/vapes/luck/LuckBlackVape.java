...
public class LuckBlackVape extends Item {

    public LuckBlackVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"luck_black_vape")))
