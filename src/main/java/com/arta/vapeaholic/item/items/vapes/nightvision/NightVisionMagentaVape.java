...
public class NightVisionMagentaVape extends Item {

    public NightVisionMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"night_vision_magenta_vape")))
