...
public class TurtleMasterBlueVape extends Item {

    public TurtleMasterBlueVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_blue_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"blue_vape"))
            .overrideDescription("item.vapeaholic.blue_vape")
        );
    }
