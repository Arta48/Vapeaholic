...
public class TurtleMasterCyanVape extends Item {

    public TurtleMasterCyanVape                                                                                                                          () {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"turtle_master_cyan_vape")))
            .modelId(Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"cyan_vape"))
            .overrideDescription("item.vapeaholic.cyan_vape")
        );
    }
