...
public class StrengthLightBlueVape extends Item {

    public StrengthLightBlueVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"strength_light_blue_vape")))
