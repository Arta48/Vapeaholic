...
public class InstantDamageBrownVape extends Item {

    public InstantDamageBrownVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"instant_damage_brown_vape")))
