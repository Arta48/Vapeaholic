...
public class FireResistanceMagentaVape extends Item {

    public FireResistanceMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"fire_resistance_magenta_vape")))
