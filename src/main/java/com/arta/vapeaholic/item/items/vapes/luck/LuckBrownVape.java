...
public class LuckBrownVape extends Item {

    public LuckBrownVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"luck_brown_vape")))
