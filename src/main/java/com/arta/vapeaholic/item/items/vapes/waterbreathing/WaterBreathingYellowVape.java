...
public class WaterBreathingYellowVape extends Item {

    public WaterBreathingYellowVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_yellow_vape")))
