...
public class StrengthMagentaVape extends Item {

    public StrengthMagentaVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"strength_magenta_vape")))
