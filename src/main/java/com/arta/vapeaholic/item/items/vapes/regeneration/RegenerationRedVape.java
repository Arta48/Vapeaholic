...
public class RegenerationRedVape extends Item {

    public RegenerationRedVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"regeneration_red_vape")))
