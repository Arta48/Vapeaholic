...
public class SlowFallingLimeVape extends Item {

    public SlowFallingLimeVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"slow_falling_lime_vape")))
