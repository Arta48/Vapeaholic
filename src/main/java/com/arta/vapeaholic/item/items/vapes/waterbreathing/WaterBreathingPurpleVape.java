...
public class WaterBreathingPurpleVape extends Item {

    public WaterBreathingPurpleVape() {
        super(ModVariables.VapeSettings
            .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Vapeaholic.MOD_ID,"water_breathing_purple_vape")))
