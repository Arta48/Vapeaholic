...
public class WaterBreathingParticle extends AnimatedParticle {
    public static WaterBreathingProvider provider(SpriteProvider spriteProvider) {
        return new WaterBreathingProvider(spriteProvider);
    }

    public static class WaterBreathingProvider implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider spriteProvider;

        public WaterBreathingProvider(SpriteProvider spriteProvider) {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random) {
            return new WaterBreathingParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, random, this.spriteProvider);
        }
    }

    public WaterBreathingParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random, SpriteProvider spriteProvider) {
