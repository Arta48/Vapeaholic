...
public class SlowFallingParticle extends AnimatedParticle {
    public static SlowFallingProvider provider(SpriteProvider spriteProvider) {
        return new SlowFallingProvider(spriteProvider);
    }

    public static class SlowFallingProvider implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider spriteProvider;

        public SlowFallingProvider(SpriteProvider spriteProvider) {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random) {
            return new SlowFallingParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, random, this.spriteProvider);
        }
    }

    public SlowFallingParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random, SpriteProvider spriteProvider) {
