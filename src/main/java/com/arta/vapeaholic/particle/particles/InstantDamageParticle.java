...
public class InstantDamageParticle extends AnimatedParticle {
    public static InstantDamageProvider provider(SpriteProvider spriteProvider) {
        return new InstantDamageProvider(spriteProvider);
    }

    public static class InstantDamageProvider implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider spriteProvider;

        public InstantDamageProvider(SpriteProvider spriteProvider) {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random) {
            return new InstantDamageParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, random, this.spriteProvider);
        }
    }

    public InstantDamageParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random, SpriteProvider spriteProvider) {
