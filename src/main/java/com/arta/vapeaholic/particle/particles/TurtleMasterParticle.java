...
public class TurtleMasterParticle extends AnimatedParticle {
    public static TurtleMasterProvider provider(SpriteProvider spriteProvider) {
        return new TurtleMasterProvider(spriteProvider);
    }

    public static class TurtleMasterProvider implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider spriteProvider;

        public TurtleMasterProvider(SpriteProvider spriteProvider) {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random) {
            return new TurtleMasterParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, random, this.spriteProvider);
        }
    }

    public TurtleMasterParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random, SpriteProvider spriteProvider) {
