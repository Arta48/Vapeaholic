...
public class SwiftnessParticle extends AnimatedParticle {
    public static SwiftnessProvider provider(SpriteProvider spriteProvider) {
        return new SwiftnessProvider(spriteProvider);
    }

    public static class SwiftnessProvider implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider spriteProvider;

        public SwiftnessProvider(SpriteProvider spriteProvider) {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random) {
            return new SwiftnessParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, random, this.spriteProvider);
        }
    }

    public SwiftnessParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random, SpriteProvider spriteProvider) {
