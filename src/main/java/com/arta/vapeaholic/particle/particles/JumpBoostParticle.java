...
public class JumpBoostParticle extends AnimatedParticle {
    ...
    public static class JumpBoostProvider implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random) {
            return new JumpBoostParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, random, this.spriteProvider);
        }
    }

    public JumpBoostParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random, SpriteProvider spriteProvider) {
