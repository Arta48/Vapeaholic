...
public class FireResistanceParticle extends AnimatedParticle {
    public static FireResistanceProvider provider(SpriteProvider spriteProvider) {
        return new FireResistanceProvider(spriteProvider);
    }

    public static class FireResistanceProvider implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider spriteProvider;

        public FireResistanceProvider(SpriteProvider spriteProvider) {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random) {
            return new FireResistanceParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, random, this.spriteProvider);
        }
    }

    public FireResistanceParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random, SpriteProvider spriteProvider) {
