...
public class WeaknessParticle extends AnimatedParticle {
    ...
    public static class WeaknessProvider implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random) {
            return new WeaknessParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, random, this.spriteProvider);
        }
    }

    public WeaknessParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random, SpriteProvider spriteProvider) {
