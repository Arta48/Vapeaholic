...
public class NightVisionParticle extends SimpleAnimatedParticle {
    private NightVisionParticle(final ClientLevel level, final double x, final double y, final double z, final double xa, final double ya, final double za, final SpriteSet sprites) {
    ...
    public static NightVisionProvider Provider(FabricSpriteSet fabricSpriteSet) {
        return new NightVisionProvider(fabricSpriteSet);
    }

    @Environment(EnvType.CLIENT)
    public static class NightVisionProvider implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet sprites;

        public NightVisionProvider(final SpriteSet sprites) {
            this.sprites = sprites;
        }

        public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
            return new NightVisionParticle(level, x, y, z, xAux, yAux, zAux, this.sprites);
        }
    }
