...
public class NightVisionParticle extends AnimatedParticle {
    public static NightVisionProvider provider(SpriteProvider spriteProvider) {
        return new NightVisionProvider(spriteProvider);
    }

    public static class NightVisionProvider implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider spriteProvider;

        public NightVisionProvider(SpriteProvider spriteProvider) {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random) {
            return new NightVisionParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, random, this.spriteProvider);
        }
    }

    public NightVisionParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random, SpriteProvider spriteProvider) {
