...
public class PoisonParticle extends SimpleAnimatedParticle {
    private PoisonParticle(final ClientLevel level, final double x, final double y, final double z, final double xa, final double ya, final double za, final SpriteSet sprites) {
    ...
    public static PoisonProvider Provider(FabricSpriteSet fabricSpriteSet) {
        return new PoisonProvider(fabricSpriteSet);
    }
    ...
    public static class PoisonProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public PoisonProvider(final SpriteSet sprites) {
            this.sprites = sprites;
        }

        public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
            return new PoisonParticle(level, x, y, z, xAux, yAux, zAux, this.sprites);
        }
    }
