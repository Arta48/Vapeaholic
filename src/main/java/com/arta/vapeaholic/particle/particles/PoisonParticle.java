...
public class PoisonParticle extends AnimatedParticle {
    public static PoisonProvider provider(SpriteProvider spriteProvider) {
        return new PoisonProvider(spriteProvider);
    }

    public static class PoisonProvider implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider spriteProvider;

        public PoisonProvider(SpriteProvider spriteProvider) {
