...
public class InstantHealthParticle extends AnimatedParticle {
    public static InstantHealthProvider provider(SpriteProvider spriteProvider) {
        return new InstantHealthProvider(spriteProvider);
    }

    public static class InstantHealthProvider implements ParticleFactory<SimpleParticleType> {
        private final SpriteProvider spriteProvider;

        public InstantHealthProvider(SpriteProvider spriteProvider) {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random) {
            return new InstantHealthParticle(clientWorld, x, y, z, velocityX, velocityY, velocityZ, random, this.spriteProvider);
        }
    }

    public InstantHealthParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Random random, SpriteProvider spriteProvider) {
